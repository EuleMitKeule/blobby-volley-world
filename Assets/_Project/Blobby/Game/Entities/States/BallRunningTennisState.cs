...
namespace Blobby.Game.Entities
{
    public class BallRunningTennisState : IBallState
    {
        ...
        public BallRunningTennisState(BallComponent ballComponent, MatchComponent matchComponent) => (_ballComponent, _matchComponent) = (ballComponent, matchComponent);
        ...
        {
            _ballComponent.HandleMapCollisionTennis();
        }
