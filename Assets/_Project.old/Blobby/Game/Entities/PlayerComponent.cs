...
namespace Blobby.Game.Entities
{
    ...
    public class PlayerComponent : MonoBehaviour, IPlayerGraphicsProvider
    {
        ...
        Vector2 DeltaGravity => Vector2.up * GRAVITY * UnityEngine.Time.fixedDeltaTime;
        Vector2 DeltaVelocity => Velocity * UnityEngine.Time.fixedDeltaTime;
        ...
        float BallDeltaDistance => BallComponent.Velocity.To(Velocity).magnitude * UnityEngine.Time.fixedDeltaTime;
