...
rm /root/blobby-volley-world-server/server.json
echo {"Name":"BV Server","Host":"127.0.0.1","Port":$1,"Token":"bla","MasterServerHost":"$2","MasterServerPort":15940} >> /root/blobby-volley-world-server/blobby-volley-world-server-linux/server.json
