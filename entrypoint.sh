...
echo {"Name":"BV Server","Host":"127.0.0.1","Port":$LISTEN_PORT,"Token":"bla","MasterServerHost":"$MASTER_SERVER_HOST","MasterServerPort":15940} >> /root/blobby-volley-world-server/serverData.json
